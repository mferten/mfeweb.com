...
@push('module')
    ...
    <br/><br/>
    <div id="rowID " class="row loginBP mfeWeb" style="text-align:center">
        <ul>
            <li>
                <a class= "appLanguageSel" href="http://www.mfeworld.com/" target="_blank">Flags (to be: or Birds or Flowers or Foods)</a>
            </li>
            <br/>
            <li>
                <a class= "appLanguageSel" href="http://www.mywebbench.com/" target="_blank">My Web Bench and Virtual Community</a>
            </li>
            <br/>
            <li>
                <a class= "appLanguageSel" href="http://www.mfework.com/" target="_blank">One of a kind Resort or Villa</a>
            </li>
            <br/>
            <li>
